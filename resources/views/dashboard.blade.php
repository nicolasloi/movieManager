                        ...
                        <th class="flex gap-14 justify-center items-center">
                            ...
                            <form method="GET" action="{{ route('dashboard') }}">
                                <div class="flex items-center">
                                    ...
                                    <input type="text" id="search" name="search" placeholder="title" value="{{ request('search') }}" class="px-2 py-1 border rounded placeholder:italic placeholder:text-gray-400">
